...
<?php renderHeader(["title" => "META MARBLE & GRANITE Slate Tiles"]);?>
	<!--prdt-starts-->
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Slate Tiles Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Slate'";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Slate Tiles'";
    echo "data-title='";
    echo $row['Name'];
