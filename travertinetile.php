	...
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Travertine Tiles Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Travertine' AND `Category`='Tile'";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Traverine Tiles'";
    echo "data-title='";
    echo $row['Name'];
    ...
    echo "</h3><h4>";
    echo $row['Finish'];
    echo "</h4><p>Travertine</p><h4>Tile</h4>";
    echo"</div></div>";
}
