...
<?php renderHeader(["title" => "META MARBLE & GRANITE Limestone Slabs"]);?>

	<!--prdt-starts-->
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Limestone & Soapstone Slabs Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Limestone' AND `Category`='Slab' OR `Material`='Soapstone' ";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Limestone Slabs'";
    echo "data-title='";
    echo $row['Name'];
