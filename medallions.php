...
<?php renderHeader(["title" => "META MARBLE & GRANITE Medallions"]);?>
	<!--prdt-starts-->
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Medallions Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Medallion'";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo "</h3><h4>";
    echo $row['Size'];
    echo "</h4><p>Medallion</p><h4>Garden Of Sagalassos</h4>";
    echo"</div></div>";
}
