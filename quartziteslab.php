...
<?php renderHeader(["title" => "META MARBLE & GRANITE Quartzite Slabs"]);?>
	<!--prdt-starts-->
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Quartzite Slabs Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Quartzite'";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Quartzite Slabs'";
    echo "data-title='";
    echo $row['Name'];
    ...
    echo $row['Name'];
    echo "</h3><p>Quartzite</p><h4>Slab</h4>";
    echo"</div></div>";
}
