...
<?php renderHeader(["title" => "META MARBLE & GRANITE Marble Slabs"]);?>
<!--prdt-starts-->
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Marble Slabs Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Marble' AND `Category`='Slab'";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Marble Slabs'";
    echo "data-title='";
    echo $row['Name'];
