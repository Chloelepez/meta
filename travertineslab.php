...
<?php renderHeader(["title" => "META MARBLE & GRANITE Travertine Slabs"]);?>
	<!--prdt-starts-->
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Travertine Slabs Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Travertine' AND `Category`='Slab'";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Travertine Slabs'";
    echo "data-title='";
    echo $row['Name'];
    ...
    echo $row['Name'];
    echo "</h3><p>Travertine</p><h4>Slab</h4>";
    echo"</div></div>";
}
