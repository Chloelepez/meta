...
<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Dolomite Slabs Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM `Products` WHERE `Material`='Dolomite'";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
   ...
   echo"<div class='col-md-3 product-left'>";
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Dolomite Slabs'";
    echo "data-title='";
    echo $row['Name'];
    ...
    echo $row['Name'];
    echo "</h3><p>Dolomite</p><h4>Slab</h4>";
    echo"</div></div>";
}
