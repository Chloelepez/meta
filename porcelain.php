	...
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Porcelain Tile Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Porcelain'";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Porcelain Tiles'";
    echo "data-title='";
    echo $row['Name'];
    ...
    echo $row['Name'];
    echo "</h3><p>Porcelain</p><h4>Tile</h4>";
    echo"</div></div>";
}
