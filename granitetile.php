...
<?php renderHeader(["title" => "META MARBLE & GRANITE Granite Tiles"]);?>
	<!--prdt-starts-->
	<div class="pages" id="pages">
		<div class="container">
			<div class="col-md-12 typo-top heading">
				<h2 class="title">Granite Tiles Selection</h2>
				</div>
			</div>
...
$sqlget = "SELECT * FROM Products WHERE `Material`='Granite' AND `Category`='Tile' ";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo"<a href='";
    echo $row['Path'];
    echo "'data-lightbox='Granite Tiles'";
    echo "data-title='";
    echo $row['Name'];
    ...
    echo $row['Name'];
    echo "</h3><p>Granite</p><h4>Tile</h4>";
    echo"</div></div>";
}
