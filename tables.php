...
<?php renderHeader(["title" => "META MARBLE & GRANITE Tables"]);?>
	<!--prdt-starts-->
...
$sqlget = "SELECT * FROM  Products WHERE `Material`='Table' ";
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo "</h3><h4>";
    echo $row['Size'];
    echo "</h4><p>Table</p><h4>Garden Of Sagalassos</h4>";
    echo"</div></div>";
}
